...
public class MemoryDataPlotter {
    ...
    private void showChart(JFreeChart chart) {
        ...
        JFrame frame = new JFrame("Memory Usage Comparison");
    ...
    public static void main(String[] args) {
        ...
        String csvFilePath = "task3/data/memory_usage.csv";
        Map<String, Map<Double, List<MemoryDataPlotter.Pair<Integer, Double>>>> benchmarkData =
                plotter.readCsvAndGroupByThreads(csvFilePath);
